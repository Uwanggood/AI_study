...
x_train_dataset = TensorDataset(
    torch.Tensor(x_train), torch.Tensor(np.array(x_train_label))
)
x_test_dataset = TensorDataset(
    torch.Tensor(x_test), torch.Tensor(np.array(x_test_label))
)
